...
public class Block {
	...
	public String toString() {
		return "Block [blockNo=" + blockNo + ", trans=" + trans + ", timestamp=" + timestamp + ", timeStamp="
				+ timeStamp + ", difficulty=" + difficulty + ", size=" + size + ", gasUsed=" + gasUsed + ", gasLimit="
				+ gasLimit + ", hash=" + hash + ", parentHash=" + parentHash + ", miner=" + miner + "]";
	}
