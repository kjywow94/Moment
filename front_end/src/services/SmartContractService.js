...
const FACTORY_CONTRACT_ADDRESS = "0x4af531e9f4b32c0C8d82ead35E85F3F460c692D0";
...
export default {
    ...
    endAccompany(contractAddress, userId, _endDate, latitude, longitude, callback) {
        var contract = this.AccompanyContract(contractAddress);
        var encodedABI = contract.methods.setEnd(userId, _endDate, latitude, longitude).encodeABI();
